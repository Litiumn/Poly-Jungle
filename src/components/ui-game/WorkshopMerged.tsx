...
/**
 * Workshop - Furniture Pack Management
 * 
 * Tabs:
 * 1. Buy Furniture Packs (Building Logs)
 * 2. My Furniture (Place furniture directly in forest)
 */
...
export function WorkshopMerged({
  buildingLogs,
  ownedFurniture,
  onBuyPack,
  onPlaceFurniture,
  onClose,
}: WorkshopMergedProps): JSX.Element {
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 text-sm text-blue-800">
                    ...
                    <p>
                      Purchase Furniture Packs using Building Logs obtained from cutting
                      mature trees. Each pack contains multiple random furniture items that
                      can be placed in your forest or sold on the Marketplace!
                    </p>
                  </div>
                </div>
              </div>
              ...
              {!isPackAvailable('Limited') && (
                <div className="mt-6 bg-red-50 border border-red-200 rounded-lg p-4 text-center">
                  <p className="text-red-800 font-bold">
                    ⏰ Limited Edition Pack has expired!
                  </p>
            ...
            <div>
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                <p className="text-sm text-green-800">
                  💡 <strong>Tip:</strong> Select furniture to place it directly in your forest! Click on terrain to place, press R to rotate. Limited-time furniture has a special glow!
                </p>
              </div>
              ...
              {unplacedFurniture.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mt-2">
                    Buy Furniture Packs to get started!
                  </p>
                  <button
                    onClick={() => setActiveTab('packs')}
                        ...
                        <div className="space-y-1 text-sm text-gray-600 mb-3">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-bold text-green-600">
                              {rarityInfo.marketValue} 🍃
                            </span>
                          </div>
                        </div>

                        <button
                          onClick={() => onPlaceFurniture(furniture.id)}
